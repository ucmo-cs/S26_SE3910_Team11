...
export const StepUserDetails = ({
  ...
  const isValid = firstName.trim() && lastName.trim() && email.trim() && email.includes("@") && phone.trim().length >= 7;
    ...
    <section>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="p-5 space-y-4">
          ...
          <Button className="w-full mt-2" disabled={!isValid || isSubmitting} onClick={onSubmit}>
